...
export function getBaseApiUrl(): string {
    const hostedOn = process.env.NEXT_PUBLIC_API_HOSTED_ON
    console.log('process.env.NEXT_PUBLIC_API_HOSTED_ON value: ', hostedOn);
    const azureOrGitHubCodespace = hostedOn === 'AZURE';
